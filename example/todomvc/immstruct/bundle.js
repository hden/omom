...
var spy = new _eventemitter32['default']();
var emit = spy.emit;
var log = (0, _debug2['default'])('todomvc:dispatcher');

_debug2['default'].enable('todomvc:*');
...
},{"../../../../index":25,"debug":11,"eventemitter3":26}],2:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
exports['default'] = _index2['default'].component(function (items /* cursor */) {
  ...
  if (completed > 0) {
    clearCompletedButton = _index2['default'].h(
      'button',
      { id: 'clear-completed', onclick: _actionsTodoAction2['default'].destroyCompleted },
...
},{"../../../../index":25,"../actions/todoAction":1,"./todoTextInput":7}],3:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
},{"../../../../index":25,"../actions/todoAction":1,"./Footer":2,"./header":4,"./mainSection":5}],4:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
exports['default'] = _index2['default'].component(function () {
  return _index2['default'].h(
    'header',
    { id: 'header' },
    _index2['default'].h(
    ...
    _index2['default'].h(_todoTextInput2['default'], {
      id: 'new-todo',
      placeholder: 'What needs to be done?',
      onSave: _actionsTodoAction2['default'].create
    })
  );
});
module.exports = exports['default'];

},{"../../../../index":25,"../actions/todoAction":1,"./todoTextInput":7}],5:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
exports['default'] = _index2['default'].component(function (items /* cursor */) {
  ...
  return _index2['default'].h(
    'section',
    { id: 'main' },
    _index2['default'].h('input', {
      id: 'toggle-all',
      type: 'checkbox',
      onchange: _actionsTodoAction2['default'].toggleAll.bind(_actionsTodoAction2['default'], !areAllComplete),
...
},{"../../../../index":25,"../actions/todoAction":1,"./todoItem":6}],6:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
exports['default'] = _index2['default'].component(function (item /* cursor */) {

  var className = _index2['default'].cx({
...
},{"../../../../index":25,"../actions/todoAction":1,"./todoTextInput":7}],7:[function(require,module,exports){
/** @jsx omom.h */
'use strict';
...
exports['default'] = function () {
  ...
  return _index2['default'].h('input', {
...
},{"../../../../index":25}],8:[function(require,module,exports){
'use strict';
...
},{"../../../index":25,"./components/app":3,"./stores/todoStore":24}],9:[function(require,module,exports){
...
},{"./src/structure":19}],15:[function(require,module,exports){
'use strict';
...
},{"immutable":17}],17:[function(require,module,exports){
/**
 *  Copyright (c) 2014-2015, Facebook, Inc.
 *  All rights reserved.
 *
...
},{"./utils":20,"eventemitter3":15,"immutable":17,"immutable/contrib/cursor":16,"inherits":18}],20:[function(require,module,exports){
'use strict';
...
(0, _actionsTodoAction2['default'])({
  ...
  onCreate: function onCreate() {
    var text = arguments[0] === undefined ? '' : arguments[0];
    var complete = arguments[1] === undefined ? false : arguments[1];
    var editing = arguments[2] === undefined ? false : arguments[2];
    ...
    itemsRef.cursor().set(id, _immutable2['default'].fromJS({ id: id, text: text, complete: complete, editing: editing }));
  },

  onUpdateText: function onUpdateText(id) {
  ...
  onToggleAll: function onToggleAll() {
    var complete = arguments[0] === undefined ? true : arguments[0];
  ...
  onDestroyCompleted: function onDestroyCompleted() {
    itemsRef.cursor().update(function (items) {
...
},{"../actions/todoAction":1,"immstruct":14,"immutable":21,"uuid":23}],25:[function(require,module,exports){
'use strict';
...
var _srcH = require('./src/h');

var _srcH2 = _interopRequireDefault(_srcH);

var _srcCx = require('./src/cx');

var _srcCx2 = _interopRequireDefault(_srcCx);

var _srcMainLoop = require('./src/main-loop');

var _srcMainLoop2 = _interopRequireDefault(_srcMainLoop);

var _srcAction = require('./src/action');

var _srcAction2 = _interopRequireDefault(_srcAction);

var _srcComponent = require('./src/component');

var _srcComponent2 = _interopRequireDefault(_srcComponent);
...
},{"./src/action":62,"./src/component":63,"./src/cx":64,"./src/h":65,"./src/main-loop":66}],26:[function(require,module,exports){
'use strict';
...
},{"./vdom/create-element.js":41}],30:[function(require,module,exports){
var diff = require("./vtree/diff.js")

module.exports = diff

},{"./vtree/diff.js":61}],31:[function(require,module,exports){
...
},{"../vnode/is-widget.js":55,"../vnode/vpatch.js":58,"./apply-properties":40,"./create-element":41,"./update-widget":45}],44:[function(require,module,exports){
var document = require("global/document")
...
},{"./dom-index":42,"./patch-op":43,"global/document":36,"x-is-array":38}],45:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/handle-thunk":50,"../vnode/is-thunk":51,"../vnode/is-vnode":53,"../vnode/is-vtext":54,"../vnode/is-widget":55,"../vnode/vpatch":58,"./diff-props":60,"x-is-array":38}],62:[function(require,module,exports){
'use strict';
...
exports['default'] = function () {
  var actions = arguments[0] === undefined ? [] : arguments[0];
  var emitter = arguments[1] === undefined ? new _eventemitter32['default']() : arguments[1];

  var helper = function helper(reciever) {
    actions.forEach(function (action) {
      var method = action.replace(/./, function (c) {
        return 'on' + c[0].toUpperCase();
      });
...
},{"eventemitter3":26}],63:[function(require,module,exports){
"use strict";
...
exports["default"] = function (render) {
  var eq = arguments[1] === undefined ? Object.is : arguments[1];

  var currentProps = undefined,
      currentChildren = undefined,
      cache = undefined;
  return function (nextProps, nextChildren) {
...
exports['default'] = function (tag) {
  ...
  return typeof tag !== 'function' ? (0, _virtualDomH2['default'])(tag, props, children) : tag(props, children);
};

module.exports = exports['default'];

},{"virtual-dom/h":31}],66:[function(require,module,exports){
'use strict';
...
exports['default'] = function (root, render) {
  ...
  return function (current) {
    ...
    var tree = render(current);
    var el = (0, _virtualDomCreateElement2['default'])(tree, options);
    ...
    var redraw = function redraw() {
      ...
      inRenderingTransaction = true;
      var newTree = render(current);
      var patches = (0, _virtualDomDiff2['default'])(tree, newTree, options);
      inRenderingTransaction = false;

      el = (0, _virtualDomPatch2['default'])(el, patches, options);
      tree = newTree;
      current = null;
    };
...
},{"raf":27,"virtual-dom/create-element":29,"virtual-dom/diff":30,"virtual-dom/patch":39}]},{},[8]);
